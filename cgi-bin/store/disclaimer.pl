...
#!/usr/bin/perl
############################################################################
# Store 2005 by Ihar Hrunt. smartcgi@mail.ru  / disclaimer.pl
#
############################################################################
...
$pathUrl =$path_cgi.'disclaimer.pl';
...
$str_menu_top="
  ...
  <A class=PathSite  href='http://store.com'>Store.com</A> &gt; <A class=PathSite  href='$pathUrl'><u>Legal Disclaimer</u></A></SPAN>";


print "Content-type: text/html\n\n";
$template_file=$path_html."html/disclaimer.html";
